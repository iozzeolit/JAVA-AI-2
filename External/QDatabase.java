...
public class QDatabase {
    ...
    public static void Init(String serverName, String databaseName) {
        serverConnString = "jdbc:sqlserver://" + serverName
    ...
    public static void InitFromConfig() {
        try {
            ...
            javax.swing.JOptionPane.showMessageDialog(null, "Error loading config.properties: " + e.getMessage(),
    ...
    public static void ExecUpdateGeneral(String connString, String query) {
        try {
            ...
            javax.swing.JOptionPane.showMessageDialog(null, "Database Query Error: " + e.getMessage(), "Error",
