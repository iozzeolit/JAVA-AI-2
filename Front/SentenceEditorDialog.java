...
public class SentenceEditorDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        sentenceTable.getColumnModel().getColumn(2).setPreferredWidth(100); // End Time
        sentenceTable.getColumnModel().getColumn(3).setPreferredWidth(500); // Text
    ...
    private void loadSentences() {
        ...
        try {
            QDatabase.select(q, new QReaderFunction() {
                @Override
                public void Fetch(java.sql.ResultSet rs) throws Exception {                    Sentence sentence = new Sentence();
    ...
    private void addSentence() {
        // Create a new sentence with default values
        ...
        try {
            ...
            for (int i = 0; i < tableModel.getRowCount(); i++) {
                ...
                for (Sentence sentence : sentences) {
                    if (sentence.id == id) {
                        // Convert string time representation to Time objects
                        ...
                        q.set("endTime = '" + secondsToTime(endSeconds) + "'");                        // Properly escape any apostrophes in the content using UnicodeHelper
